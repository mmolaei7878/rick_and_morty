...
class CharacterModel extends Equatable {
  ...
  late final List<SingleCharacter> singleCharacter;

  CharacterModel.fromJson(Map<String, dynamic> json) {
    info = Info.fromJson(json['info']);
    singleCharacter = List.from(json['results']).map((e) => SingleCharacter.fromJson(e)).toList();
  }
...
class SingleCharacter {
  ...
  SingleCharacter.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    status = json['status'];
